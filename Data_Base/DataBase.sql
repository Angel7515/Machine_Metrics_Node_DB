...
-- -----------------------------------------------------
-- Table `kmit_projects_dashboard`.`person_has_kpis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kmit_projects_dashboard`.`person_has_kpis` (
  `person_idactive` VARCHAR(45) NOT NULL,
  `kpis_idkpis` INT NOT NULL,
  `kpis_project_idproject` INT NOT NULL,
  PRIMARY KEY (`person_idactive`, `kpis_idkpis`, `kpis_project_idproject`),
  CONSTRAINT `fk_person_has_kpis_person1`
    FOREIGN KEY (`person_idactive`)
    REFERENCES `kmit_projects_dashboard`.`person` (`idactive`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_person_has_kpis_kpis1`
    FOREIGN KEY (`kpis_idkpis` , `kpis_project_idproject`)
    REFERENCES `kmit_projects_dashboard`.`kpis` (`idkpis` , `project_idproject`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_person_has_kpis_kpis1_idx` ON `kmit_projects_dashboard`.`person_has_kpis` (`kpis_idkpis` ASC, `kpis_project_idproject` ASC) VISIBLE;

CREATE INDEX `fk_person_has_kpis_person1_idx` ON `kmit_projects_dashboard`.`person_has_kpis` (`person_idactive` ASC) VISIBLE;
